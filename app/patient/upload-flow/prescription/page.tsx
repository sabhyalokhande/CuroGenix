...
export default function PrescriptionUploadFlow() {
  ...
  // Only run camera logic after mount
      ...
      <div className="p-4">
        ...
        {step === "review" && (
          <div className="space-y-6">
            ...
            <Button onClick={handleViewOnMap} className="w-full h-12 glass-button border-0 cursor-pointer" style={{ touchAction: "manipulation" }}>
