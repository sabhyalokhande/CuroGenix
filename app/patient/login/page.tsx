      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="glass-card border-0">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-white">Patient Access</CardTitle>
            <CardDescription className="text-gray-300">Sign in to search medicines and report issues</CardDescription>
          </CardHeader>
          <CardContent>
