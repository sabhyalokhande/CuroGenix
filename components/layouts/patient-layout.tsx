...
import { Heart, Search, AlertTriangle, Award, Upload, HelpCircle, Menu, User, LogOut } from "lucide-react"
...
const navigation = [
  ...
  { name: "Search Medicines", href: "/patient/search", icon: Search },
  { name: "Report Problem", href: "/patient/report", icon: AlertTriangle },
  { name: "Rewards", href: "/patient/rewards", icon: Award },
  { name: "My Uploads", href: "/patient/uploads", icon: Upload },
  { name: "Help Center", href: "/patient/help", icon: HelpCircle },
]
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <Link href="/patient/dashboard" className="flex items-center space-x-2 ml-4 md:ml-0">
                <Heart className="h-8 w-8 text-green-400" />
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center space-x-2 glass-button border-0">
                    ...
                    <span className="hidden sm:block text-white">Patient</span>
                  </Button>
                </DropdownMenuTrigger>
